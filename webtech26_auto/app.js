/**
 * Taxi Register - Senior Client Application Logic
 * Verzió: 1.2.0
 * Kiegészítés: Komplex üzleti logika validáció és szerverhiba kezelés
 */
...
const UI = {
    ...
    // Kibővített Toast: piros háttér hiba esetén, kék sikeres műveletnél
    toast(msg, type = 'info') {
        const t = document.getElementById('toast');
        t.innerText = msg;
        
        // Színkódolás a hiba típusától függően
...
const App = {
    ...
    /**
     * Üzleti logika validáció és mentés
     */
    async save(e) {
        e.preventDefault();
        ...
        // --- ÜZLETI LOGIKA KORLÁTOZÁSOK (Kliens oldali figyelmeztetések) ---
        
        // 1. Márka validáció: ne legyen túl rövid
        if (brand.length < 2) {
